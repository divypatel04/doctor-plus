      ...
      <View style={styles.container}>
        ...
        <View style={styles.section2}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("D_addReport", { DocAppID: DocAppID })
            }
          >
            <Text style={styles.LoginButtonText}>Add Report</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.section3}>
          ...
          <View style={styles.List}>
            <View style={styles.text}>
              <Text style={styles.Name}>Patient Description</Text>
