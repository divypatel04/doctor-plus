...
const Doctor_ManageSingle = ({ navigation, route }) => {
  ...
  const approved = () => {
    db.ref("/Doc_Appointment/")
      ...
      .set({
        ...
        D_id: getColumn(DAData, "D_id"),
        Time: getColumn(DAData, "Time"),
        Status: "Approved",
        Blood_Pressure: getColumn(DAData, "Blood_Pressure"),
        Sugar: getColumn(DAData, "Sugar"),
        Temperature: getColumn(DAData, "Temperature"),
        Pulse: getColumn(DAData, "Pulse"),
        Patient_Desc: getColumn(DAData, "Patient_Desc"),
        DocApp_id: getColumn(DAData, "DocApp_id"),
      })
      .catch((e) => setError(e));
...
export default Doctor_ManageSingle;
