...
const Book_Appointment = ({ navigation, route }) => {
  ...
  const submitted = () => {
    ...
    if (Sugar == "") {
      setError("Enter Sugar Level");
    }
    if (Pulse == "") {
      setError("Enter Pulse");
    }
    if (Temp == "") {
      setError("Enter Temperature");
    }
    if (Desc == "") {
    ...
    if (
      ...
      const id = db.ref("/Doc_Appointment/").push().getKey();
      ...
      db.ref("/Doc_Appointment/")
        ...
        .catch((e) => setError(e));
      ToastAndroid.showWithGravity(
        "Booked Successfully | Wait For Doctor's Approval",
        ToastAndroid.LONG,
        ToastAndroid.CENTER
      );
      navigation.navigate("D_Profile", { DoctorID: DoctorID });
    }
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.section2}>
          ...
          <TextInput
            ...
            onChangeText={(newText) => setBlood(newText)}
            placeholder="Enter Blood Pressure"
          />
          <TextInput
            style={styles.Input}
            keyboardType="numeric"
            onChangeText={(newText) => setSugar(newText)}
            placeholder="Enter Sugar Level"
          />
          <TextInput
            style={styles.Input}
            keyboardType="numeric"
            onChangeText={(newText) => setPulse(newText)}
