...
const P_Report = ({ navigation }) => {
  ...
  const dlist = () => {
    return DD.map((element) => {
      ...
      if (element.P_id == Patient_id && element.Status == "Completed") {
        return (
          <TouchableOpacity
            onPress={() =>
              navigation.navigate("P_viewReport", {
                LabAppID: "",
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.container}>
        ...
        <View style={styles.sTitle}>
          <Text style={styles.ssTitle}>Doctor's Reports</Text>
        </View>
        {dlist()}
        <View style={styles.sTitle}>
          <Text style={styles.ssTitle}>Lab's Reports</Text>
        </View>
        {list()}
      </View>
    </ScrollView>
