...
const Lab_Home = ({ navigation }) => {
  ...
  getd();
  const logout = () => {
    AsyncStorage.removeItem("Lab_Session");
    console.log("logout");
    navigation.navigate("Login");
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.section}>
        <TouchableOpacity onPress={() => navigation.navigate("Lab_Manage")}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate("L_TAppointments")}
        >
          <View style={styles.homecard}>
            <Image
              style={styles.homecardIcon}
      ...
      <View style={styles.section}>
        <TouchableOpacity
          onPress={() => navigation.navigate("L_HAppointments")}
        >
          <View style={styles.homecard}>
            <Image
              style={styles.homecardIcon}
        ...
        <TouchableOpacity onPress={() => navigation.navigate("L_Profile")}>
          <View style={styles.homecard}>
            <Image
              style={styles.homecardIcon}
