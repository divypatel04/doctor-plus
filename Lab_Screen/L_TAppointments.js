...
const L_TAppointments = ({ navigation }) => {
    ...
    return PD.map((element) => {
      ...
      if (
        ...
        return (
          <TouchableOpacity
            onPress={() =>
              navigation.navigate("L_SA", { LabAppID: element.LabApp_id })
            }
          >
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.Logintext}>Today's Appointments</Text>
        </View>
        {dlist()}
      </View>
    </ScrollView>
...
export default L_TAppointments;
