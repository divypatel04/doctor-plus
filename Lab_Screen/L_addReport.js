...
const L_addReport = ({ navigation, route }) => {
  ...
  const submitted = async () => {
    ...
    if (ReportFile != "") {
      ...
      db.ref("/Lab_Appointment/")
        .child(LabAppID)
        .set({
          Address: getColumn(PatientData, "Address"),
          L_id: getColumn(PatientData, "L_id"),
          LabApp_id: getColumn(PatientData, "LabApp_id"),
          P_id: getColumn(PatientData, "P_id"),
          ReportName: getColumn(PatientData, "ReportName"),
          Status: "Completed",
